        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-gray-800">SAVFAB Developers Pvt. Ltd.</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-gray-800 mb-6">Key Location & Features</h2>
              <ul className="space-y-4 text-lg text-gray-600">
                <li className="flex items-center">
                  <MapPin className="text-amber-600 mr-3 w-6 h-6" /> Situated at NH-24, Ghaziabad.
                </li>
                <li className="flex items-center">
                  <Building className="text-amber-600 mr-3 w-6 h-6" /> Proposed 14 Lane NH-24 Express Way
                </li>
                <li className="flex items-center">
                  <MapPin className="text-amber-600 mr-3 w-6 h-6" /> 02 min. drive from Columbia Asia Hospital
                </li>
                <li className="flex items-center">
                  <MapPin className="text-amber-600 mr-3 w-6 h-6" /> 05 min. drive from Lal Kaun
                </li>
                <li className="flex items-center">
                  <MapPin className="text-amber-600 mr-3 w-6 h-6" /> 10 min. drive from Noida
                </li>
                <li className="flex items-center">
                  <MapPin className="text-amber-600 mr-3 w-6 h-6" /> 15 min. drive from Old Railway Station.
                </li>
              </ul>
              <div className="mt-8 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <a href="#" className="flex-1 text-center py-4 px-6 rounded-xl bg-blue-600 text-white font-semibold shadow-lg hover:bg-blue-700 transition-colors">
                  <span className="inline-block mr-2">Download Brochure</span>
                </a>
                <a href="tel:+919015750750" className="flex-1 text-center py-4 px-6 rounded-xl bg-red-500 text-white font-semibold shadow-lg hover:bg-red-600 transition-colors">
                  <span className="inline-block mr-2">Contact Us</span>
                </a>
              </div>
              <a href="tel:+919015750750" className="flex items-center justify-center mt-6 py-4 px-6 rounded-xl bg-amber-500 text-white font-bold shadow-lg hover:bg-amber-600 transition-colors">
      ...
      <section className="py-20 bg-gray-50">
        ...
        <div className="overflow-hidden">
          <div className="flex space-x-12 animate-scroll-logos">
            {/* Repeat the logo list to create a seamless loop */}
