...
const AboutPage = () => {
  return (
    <div id="about" className="min-h-screen pt-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              The Project "Jasmine Grove" enjoys a strong presence in NCR and
              has made its position as one of the reliable names in the Real
              Estate Industry. We focus on luxury living at reasonable costs
              with excellent customer care and timely delivery.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-color-3">
                SAVFAB Developers Pvt. Ltd.
              </h2>
              <p className="text-lg text-gray-600 leading-relaxed">
                Our group was established in 1998 and has delivered multiple
              ...
              <p className="text-lg text-color-4 font-semibold leading-relaxed">
                ...
                fulfilling dreams of buyers. We are committed to "CREATING HOME
                TO HAPPINESS".
              </p>
            </div>
          </div>
