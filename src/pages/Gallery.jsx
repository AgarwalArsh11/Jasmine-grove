    ...
    <div className="min-h-screen pt-0">
      <section className="py-10 bg-gradient-to-br from-color-1/10 via-white to-color-1/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Take a closer look at our premium residences, interiors and
            lifestyle amenities.
          </p>
        </div>
      </section>
                ...
                {[...Array(2)].map((_, listIndex) => (
                  <React.Fragment key={listIndex}>
                    {images.map((src, index) => (
                      <div
                        key={index}
                        className="flex-shrink-0 w-72 md:w-80 lg:w-96 h-64 md:h-80 lg:h-96 rounded-3xl overflow-hidden mx-4 group cursor-pointer shadow-lg"
      ...
      <section className="py-16 bg-gray-50">
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold bg-gradient-to-r from-color-4 to-color-3 bg-clip-text text-transparent mb-6">
              ...
              {[...Array(2)].map((_, listIndex) => (
                <React.Fragment key={listIndex}>
                  <img
                    src={hdfcLogo}
                    alt="HDFC Bank"
                    className="h-24 md:h-28 flex-shrink-0 mx-8 object-contain transition-all duration-300"
                  />
                  <img
                    src={iciciLogo}
                    alt="ICICI Bank"
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-bold bg-gradient-to-r from-color-4 to-color-3 bg-clip-text text-transparent mb-4">
              Our Core Values
            </h2>
            ...
            {[
              {
                ...
                desc: "We believe in honest communication and transparent processes.",
              },
              {
                title: "Sustainable Living",
                desc: "Our developments incorporate eco-friendly practices for a greener future.",
              },
              {
                title: "Community Focus",
                desc: "We create spaces that foster community connections.",
              },
            ].map((value, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-color-1/10 to-white p-6 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 text-center group"
              >
                ...
                <h3 className="text-2xl font-bold text-color-3 mb-4">
                  {value.title}
                </h3>
