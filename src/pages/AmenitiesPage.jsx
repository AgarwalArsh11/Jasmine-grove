...
const AmenitiesPage = () => {
  ...
  const amenities = [
    ...
    { category: 'recreation', icon: <Waves className="w-8 h-8" />, title: 'Infinity Swimming Pool', description: 'Stunning rooftop infinity pool with panoramic city views and poolside lounge', image: amenity2 },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredAmenities.map((amenity, index) => (
              <div
                key={index}
                className="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transform hover:scale-[1.02] transition-all duration-500"
              >
